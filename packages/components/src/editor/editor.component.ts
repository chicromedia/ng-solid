...
export class NsEditorComponent extends NsFormControlValueAccessor<string> implements OnInit, OnDestroy
{
    ...
    @ViewChild( NsContentEditableComponent, { read: ElementRef, static: true } ) textArea: ElementRef<HTMLElement>;
