...
export const egg: NsIconDefinition = {
    name: 'egg',
    icon: `<path d="M16,3c-3,0-5.7,2.3-7.7,5.2C6.3,11.1,5,14.7,5,18c0,3.5,1.2,6.3,3.2,8.2C10.3,28,13,29,16,29c3,0,5.7-0.9,7.8-2.8 S27,21.5,27,18c0-3.3-1.3-6.9-3.3-9.8C21.7,5.3,19,3,16,3z M16,5c1.9,0,4.2,1.7,6,4.3c1.8,2.6,3,6,3,8.7c0,3.1-1,5.3-2.6,6.7 C20.8,26.2,18.6,27,16,27c-2.6,0-4.8-0.8-6.4-2.3C8,23.2,7,21,7,18c0-2.8,1.2-6.1,3-8.7C11.8,6.7,14.1,5,16,5z"/>`
};
